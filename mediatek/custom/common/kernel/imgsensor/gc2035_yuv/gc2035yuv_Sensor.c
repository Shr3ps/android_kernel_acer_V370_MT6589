...
static DEFINE_SPINLOCK(gc2035_yuv_drv_lock);
...
/* 
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x0d , 0xf0); //[7] exp level mode [6:4]index select
	GC2035_write_cmos_sensor(0x1a , 0x9a); //gain change ratio 0x80 =0x1x
	GC2035_write_cmos_sensor(0x27 , 0x00);
	GC2035_write_cmos_sensor(0x28 , 0xdd);

	GC2035_write_cmos_sensor(0x29 , 0x02);
	GC2035_write_cmos_sensor(0x2a , 0x97); //level 0  18fps
	GC2035_write_cmos_sensor(0x2b , 0x05); 
	GC2035_write_cmos_sensor(0x2c , 0x2e); //level 1 16fps
	GC2035_write_cmos_sensor(0x2d , 0x06);
	GC2035_write_cmos_sensor(0x2e , 0x0b); //level 2  14fps
	GC2035_write_cmos_sensor(0x2f , 0x06);
	GC2035_write_cmos_sensor(0x30 , 0xe8); //level 3 12fps
	GC2035_write_cmos_sensor(0x31 , 0x07);
	GC2035_write_cmos_sensor(0x32 , 0xc5); //11fps
	GC2035_write_cmos_sensor(0x33 , 0x08);
	GC2035_write_cmos_sensor(0x34 , 0xa2); //10fps
	GC2035_write_cmos_sensor(0x33 , 0x0a);
	GC2035_write_cmos_sensor(0x34 , 0x5c); //8fps

	GC2035_write_cmos_sensor(0x37 , 0x30);//max gain1
	GC2035_write_cmos_sensor(0x38 , 0x30);//max gain2
	GC2035_write_cmos_sensor(0x39 , 0x30);//max gain3
	GC2035_write_cmos_sensor(0x3a , 0x40);//max gain4
	GC2035_write_cmos_sensor(0x3b , 0x40);//max gain5
	GC2035_write_cmos_sensor(0x3c , 0x40);//max gain6
	GC2035_write_cmos_sensor(0x3d , 0x40);//max gain7
	/////end/////
*/
	...
	GC2035_write_cmos_sensor(0x80 , 0xff);  //block enable
	...
	GC2035_write_cmos_sensor(0xc4 , 0x10);
	GC2035_write_cmos_sensor(0xc8 , 0x11);
	GC2035_write_cmos_sensor(0xc9 , 0x11);
	GC2035_write_cmos_sensor(0xca , 0x0f);
	GC2035_write_cmos_sensor(0xbc , 0x35);
	GC2035_write_cmos_sensor(0xbd , 0x1d);
	GC2035_write_cmos_sensor(0xbe , 0x1d);
	GC2035_write_cmos_sensor(0xb6 , 0x2d);
	GC2035_write_cmos_sensor(0xb7 , 0x23);
	GC2035_write_cmos_sensor(0xb8 , 0x12);
	...
	GC2035_write_cmos_sensor(0xbb , 0x0c);
	GC2035_write_cmos_sensor(0xaa , 0x0a);
	GC2035_write_cmos_sensor(0xab , 0x05);
	GC2035_write_cmos_sensor(0xac , 0x09);
	GC2035_write_cmos_sensor(0xad , 0x06);
	GC2035_write_cmos_sensor(0xae , 0x06);
	GC2035_write_cmos_sensor(0xaf , 0x0b);
	GC2035_write_cmos_sensor(0xb0 , 0x00);
	GC2035_write_cmos_sensor(0xb1 , 0x00);
	GC2035_write_cmos_sensor(0xb2 , 0x00);
	GC2035_write_cmos_sensor(0xb3 , 0x05);
	GC2035_write_cmos_sensor(0xb4 , 0x05);
	GC2035_write_cmos_sensor(0xb5 , 0x08);
	GC2035_write_cmos_sensor(0xd0 , 0x00);
	GC2035_write_cmos_sensor(0xd2 , 0x00);
	GC2035_write_cmos_sensor(0xd3 , 0x08);
	GC2035_write_cmos_sensor(0xd8 , 0x0e);
	GC2035_write_cmos_sensor(0xda , 0x0c);
	GC2035_write_cmos_sensor(0xdb , 0x18);
	GC2035_write_cmos_sensor(0xdc , 0x00);
	GC2035_write_cmos_sensor(0xde , 0x03);
	GC2035_write_cmos_sensor(0xdf , 0x14);
	GC2035_write_cmos_sensor(0xd4 , 0x00);
	GC2035_write_cmos_sensor(0xd6 , 0x00);
	GC2035_write_cmos_sensor(0xd7 , 0x09);
	...
	GC2035_write_cmos_sensor(0xa8 , 0x02);
	...
	GC2035_write_cmos_sensor(0xfe, 0x01);
	GC2035_write_cmos_sensor(0xc2, 0x1b);
	GC2035_write_cmos_sensor(0xc3, 0x0d);
	GC2035_write_cmos_sensor(0xc4, 0x0b);
	GC2035_write_cmos_sensor(0xc8, 0x15);
	GC2035_write_cmos_sensor(0xc9, 0x10);
	GC2035_write_cmos_sensor(0xca, 0x0a);
	GC2035_write_cmos_sensor(0xbc, 0x3f);
	GC2035_write_cmos_sensor(0xbd, 0x24);
	GC2035_write_cmos_sensor(0xbe, 0x29);
	GC2035_write_cmos_sensor(0xb6, 0x3f);
	GC2035_write_cmos_sensor(0xb7, 0x2e);
	GC2035_write_cmos_sensor(0xb8, 0x15);
	GC2035_write_cmos_sensor(0xc5, 0x2a);
	GC2035_write_cmos_sensor(0xc6, 0x2b);
	GC2035_write_cmos_sensor(0xc7, 0x21);
	GC2035_write_cmos_sensor(0xcb, 0x26);
	GC2035_write_cmos_sensor(0xcc, 0x21);
	GC2035_write_cmos_sensor(0xcd, 0x20);
	GC2035_write_cmos_sensor(0xbf, 0x21);
	GC2035_write_cmos_sensor(0xc0, 0x1d);
	GC2035_write_cmos_sensor(0xc1, 0x16);
	GC2035_write_cmos_sensor(0xb9, 0x0e);
	GC2035_write_cmos_sensor(0xba, 0x0b);
	GC2035_write_cmos_sensor(0xbb, 0x24);
	GC2035_write_cmos_sensor(0xaa, 0x11);
	GC2035_write_cmos_sensor(0xab, 0x12);
	GC2035_write_cmos_sensor(0xac, 0x0d);
	GC2035_write_cmos_sensor(0xad, 0x0e);
	GC2035_write_cmos_sensor(0xae, 0x0c);
	GC2035_write_cmos_sensor(0xaf, 0x0c);
	GC2035_write_cmos_sensor(0xb0, 0x0f);
	GC2035_write_cmos_sensor(0xb1, 0x05);
	GC2035_write_cmos_sensor(0xb2, 0x07);
	GC2035_write_cmos_sensor(0xb3, 0x19);
	GC2035_write_cmos_sensor(0xb4, 0x19);
	GC2035_write_cmos_sensor(0xb5, 0x14);
	GC2035_write_cmos_sensor(0xd0, 0x04);
	GC2035_write_cmos_sensor(0xd2, 0x01);
	GC2035_write_cmos_sensor(0xd3, 0x0f);
	GC2035_write_cmos_sensor(0xd8, 0x0b);
	GC2035_write_cmos_sensor(0xda, 0x11);
	GC2035_write_cmos_sensor(0xdb, 0x1a);
	GC2035_write_cmos_sensor(0xdc, 0x13);
	GC2035_write_cmos_sensor(0xde, 0x26);
	GC2035_write_cmos_sensor(0xdf, 0x26);
	GC2035_write_cmos_sensor(0xd4, 0x0e);
	GC2035_write_cmos_sensor(0xd6, 0x0b);
	GC2035_write_cmos_sensor(0xd7, 0x20);
	GC2035_write_cmos_sensor(0xa4, 0x00);
	GC2035_write_cmos_sensor(0xa5, 0x00);
	GC2035_write_cmos_sensor(0xa6, 0x00);
	GC2035_write_cmos_sensor(0xa7, 0x00);
	...
	GC2035_write_cmos_sensor(0xc1 , 0x3e);// //3c//D -light
	GC2035_write_cmos_sensor(0xc2 , 0xfc);
	GC2035_write_cmos_sensor(0xc3 , 0x07);// 05 andy
	GC2035_write_cmos_sensor(0xc4 , 0xec);
	GC2035_write_cmos_sensor(0xc5 , 0x42);
	GC2035_write_cmos_sensor(0xc6 , 0xf8);
	
	GC2035_write_cmos_sensor(0xc7 , 0x42);//40    //// CWF TL84
	GC2035_write_cmos_sensor(0xc8 , 0xf8);
	GC2035_write_cmos_sensor(0xc9 , 0x0a);// 06 andy
	GC2035_write_cmos_sensor(0xca , 0xfd);
	GC2035_write_cmos_sensor(0xcb , 0x3e);
	GC2035_write_cmos_sensor(0xcc , 0xf7);// f 3 andy
	
	GC2035_write_cmos_sensor(0xcd , 0x38);//36 // A-light
	GC2035_write_cmos_sensor(0xce , 0xf6);
	GC2035_write_cmos_sensor(0xcf , 0x06);// 04 andy
	GC2035_write_cmos_sensor(0xe3 , 0x0c);
	GC2035_write_cmos_sensor(0xe4 , 0x44);
	GC2035_write_cmos_sensor(0xe5 , 0xe8);// andy e5
	
	GC2035_write_cmos_sensor(0xfe , 0x00);
	//===awb
	//AWB clear
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x4f , 0x00);  // 00
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);
	GC2035_write_cmos_sensor(0x4e , 0x80);
	GC2035_write_cmos_sensor(0x4e , 0x80);//d50
	GC2035_write_cmos_sensor(0x4e , 0x02);//d50
	GC2035_write_cmos_sensor(0x4e , 0x02);//d65
	GC2035_write_cmos_sensor(0x4e , 0x02);//d65
	GC2035_write_cmos_sensor(0x4d , 0x53);
	GC2035_write_cmos_sensor(0x4e , 0x08);//cwf
	GC2035_write_cmos_sensor(0x4e , 0x04);//cwf
	...
	GC2035_write_cmos_sensor(0xfe , 0x01);
		...
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x08);//D50//CWF
		GC2035_write_cmos_sensor(0x4e , 0x04);////????
		GC2035_write_cmos_sensor(0x4e , 0x00); 
		GC2035_write_cmos_sensor(0x4e , 0x02); //D65 baoliu
		GC2035_write_cmos_sensor(0x4e , 0x00); 
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		...
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00); 
		GC2035_write_cmos_sensor(0x4e , 0x10);//D50// TL84 
		GC2035_write_cmos_sensor(0x4e , 0x04);//BEIYONG 
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		...
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00); ///////////////////
		GC2035_write_cmos_sensor(0x4e , 0x10);//TL84 baoliu
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		...
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4d , 0xf0); /////////////////f0
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
		GC2035_write_cmos_sensor(0x4e , 0x00);
...
UINT32 GC2035GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	//pSensorResolution->SensorFullWidth=GC2035_IMAGE_SENSOR_PV_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;
	//pSensorResolution->SensorFullHeight=GC2035_IMAGE_SENSOR_PV_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;
...
{
	printk("[chj-gc2035]GC2035_set_param_wb para=%d \n",para);
	switch (para)
	{
		case AWB_MODE_AUTO:
...
BOOL GC2035_set_param_effect(UINT16 para)
{
	...
	printk("[chj-gc2035]GC2035_set_param_effect para=%d\n ",para);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2a,0x2e);
		...
		/*GC2035_write_cmos_sensor(0x05,0x00);//hb
		GC2035_write_cmos_sensor(0x06,0xfd);
		GC2035_write_cmos_sensor(0x07,0x00);//vb
		GC2035_write_cmos_sensor(0x08,0x43);
		GC2035_SET_PAGE1;
		GC2035_write_cmos_sensor(0x27,0x00);//step
		GC2035_write_cmos_sensor(0x28,0xb5);
		GC2035_write_cmos_sensor(0x29,0x04);//level1
		GC2035_write_cmos_sensor(0x2a,0xf3);
		GC2035_write_cmos_sensor(0x2b,0x07);//level2
		GC2035_write_cmos_sensor(0x2c,0x12);
		GC2035_write_cmos_sensor(0x2d,0x08);//level3
		GC2035_write_cmos_sensor(0x2e,0x7c);
		GC2035_write_cmos_sensor(0x2f,0x10);//level4
...
{
	printk("[chj-gc2035]GC2035_set_param_exposure para=%d \n",para);
	switch (para)
	{
		case AE_EV_COMP_n13:
			GC2035_SET_PAGE1;
		...
		case AE_EV_COMP_n07:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x54);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_n03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x56);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x84);  // 0x68   zyx : 0x78/0x80  78
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x95);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_07:
			GC2035_SET_PAGE1;
