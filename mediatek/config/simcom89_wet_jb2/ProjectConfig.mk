...
CUSTOM_KERNEL_ACCELEROMETER = kxtik1004_auto  kxtj2_auto
...
CUSTOM_KERNEL_LCM =otm9608a_qhd_dsi_vdo_yushun  # nt35590_hd720_dsi_vdo_truly     
CUSTOM_KERNEL_LEDS=mt65xx
CUSTOM_KERNEL_LENS=ov8825af dummy_lens
#punk
CUSTOM_KERNEL_MAGNETOMETER = st480 akm8963
...
CUSTOM_LK_LCM =otm9608a_qhd_dsi_vdo_yushun  # nt35590_hd720_dsi_vdo_truly
CUSTOM_MODEM=
CUSTOM_PRELOADER_CUSTOM=custom
CUSTOM_SEC_AUTH_SUPPORT=no
CUSTOM_SEC_SIGNTOOL_SUPPORT=no
CUSTOM_UBOOT_LCM = otm9608a_qhd_dsi_vdo_yushun  # nt35590_hd720_dsi_vdo_truly
#DEFAULT_INPUT_METHOD=com.sohu.inputmethod.sogou.SogouIME
DEFAULT_INPUT_METHOD=com.nuance.swype.input.IME
...
MTK_PRODUCT_LOCALES = en_US en_GB fr_FR it_IT de_DE ru_RU nl_NL zh_TW zh_CN in_ID ms_MY es_ES pt_PT ro_RO th_TH uk_UA hi_IN pl_PL my_MM km_KH ar_EG hdpi
...
SIMCOM_POWER_ON_VIBR_SUPPORT=yes
SUPPORT_PS_CALI=yes
SUPPORT_CALLINGLIGHT=no
TPD_PROXIMITY=no
TP_FW_UPGRADE_SUPPORT=no
#adupsfota start
ADUPS_FOTA_SUPPORT = no
ADUPS_FOTA_WITH_ICON = no
#adupsfota end
#cooee start
COOEE_LAUNCHER_SUPPORT = no
COOEE_S3_LAUNCHER = no
COOEE_MIUI2_LAUNCHER = no
#cooee end
SDCARD_UPDATE_MENU = no

#add by NavyGuo
SIMCOM_TORCH_SUPPORT = no

#Implemented for T card update logo and animation,caobo
SDCARD_UPDATE_LOGO_ANIMATION = no

#add by wangying for profiles widget 2013-07-03
MMI_PROFILES_WIDGET = no
SIMCOM_PHILIPS_ALARM_WIDGET_APP = no

# SIMCOM CFG
PROJECT_NAME = ACER_C11
CUSTOM_NAME = 
SIMCOM_POWER_ON_VIBR_SUPPORT  = yes
SUPPORT_PS_CALI=yes
ACER_CAMERA_SUPPORT = no
