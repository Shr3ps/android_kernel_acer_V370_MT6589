...
#define V_CHARGER_COMPATIBLE_V        4550
...
#else
         #if defined (ACER_C11)
		    if (( (BMT_status.bat_vol >= RECHARGING_VOLTAGE) && (BMT_status.bat_full == KAL_TRUE) ) ||((bat_volt_check_point == 100) && BMT_status.bat_vol >= 4200 ))
	     #else
...
void select_charging_curret_bcct(void)
{
	...
	#if defined (ACER_C11)
        bq24158_config_interface_reg(0x02,VOREG_4260MV);
    #else
